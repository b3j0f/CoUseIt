...
'<nav>' +
'Catégorie ' +
'<a class="breadcrumb dropdown-button" id="topcategory" href="#" data-activates="topcategories" data-beloworigin="true" data-constrainWidth="false" data-gutter="0" data-hover="true" name="topcategory">{% trans 'All' %}</a>' +
'<ul name="topcategories" id="topcategories" class="dropdown-content">' +
'</ul>' +
'<a class="breadcrumb dropdown-button" id="midcategory" href="#" data-activates="midcategories" data-beloworigin="true" data-constrainWidth="false" data-hover="true">{% trans 'All' %}</a>' +
'<ul name="midcategories" id="midcategories" class="dropdown-content">' +
'</ul>' +
'<a class="breadcrumb dropdown-button" id="lowcategory" href="#" data-activates="lowcategories" data-beloworigin="true" data-constrainWidth="false" data-hover="true">{% trans 'All' %}</a>' +
...
var toplis = '<li id="topall" class="active"><a onclick="selectcat(\'top\', this);">{% trans 'All' %}</a></li>';
var midlis = '<li id="midall" class="active"><a onclick="selectcat(\'mid\', this);">{% trans 'All' %}</a></li>';
var lowlis = '<li id="lowall" class="active"><a onclick="selectcat(\'low\', this);">{% trans 'All' %}</a></li>';

{% for topcategory in topcategories %}
var topcat = '{{ topcategory.name }}'.replace('/', '-');
topcategories['{{ topcategory.name }}'] = [];
toplis += '<li class="top"><a id="' + topcat + '" onclick="selectcat(\'top\', this)">{% trans topcategory.display_name %}</a></li>';
...
midlis += '<li class="mid ' + topcat + '"><a id="' + midcat + '" onclick="selectcat(\'mid\', this)">{% trans midcategory.display_name %}</a></li>';
...
lowlis += '<li class="low ' + topcat + ' ' + midcat + '"><a id="' + lowcat + '" onclick="selectcat(\'low\', this)">{% trans lowcategory.display_name %}</a></li>';
		{% endfor %}
	{% endfor %}
{% endfor %}
